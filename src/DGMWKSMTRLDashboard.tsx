...
export default function DGMWKSMTRLDashboard() {
  const navigate = useNavigate()
  ...
  const cards = [
    ...
    {
      title: 'MPO',
      subtitle: 'Material Planning Organization',
      gradient: 'bg-gradient-to-br from-teal-600 to-teal-800',
      route: '/mpo'
    },
    {
      title: 'ESS',
      subtitle: 'Equipment Support Section',
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-fr">
          {/* DGM Dashboard - Spans 3 columns on medium screens and up */}
          ...
          {/* MCO, MPO, ESS - Three cards side by side */}
          <DashboardCard
            title={cards[1].title}
