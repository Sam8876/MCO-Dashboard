...
export default function MCODashboard() {
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
      ...
      {selectedSection === 'cvil' && (
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-6">CVIL Management</h3>
      ...
      {selectedSection === 'ohs' && (
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-6">OHS</h3>
      ...
      {selectedSection === 'return' && (
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-6">Report & Return</h3>
      ...
      {selectedSection === 'vir' && (
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-6">VIR (Visual Inspection Report)</h3>
      ...
      {selectedSection === 'defect' && (
        <div>
          <h3 className="text-xl font-bold text-gray-900 mb-6">Defect Report</h3>
